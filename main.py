...
VERSION = "v2.7 (Final Stable Form)"
        ...
        if len(selected_indices) > 0:
            ...
            with st.form("complete_form"):
                ...
                for _, row in selection.iterrows():
                    ...
                    c_c.selectbox("Markierung", ["Grau", "Grün", "Rot"], key=f"col_{pid}", index=idx, label_visibility="collapsed")
            ...
            if submitted:
                ...
                for pid in widget_keys:
                    ...
                    for k in ['l1','l2','l3','l4','r1','r2','r3','r4']:
                        st.session_state.saved_notes[f"{k}_{pid}"] = st.session_state[f"{k}_{pid}"]
                ...
                for idx, row in selection.iterrows():
                    ...
                    html += generate_card_html(row.to_dict(), meta, p_notes, c_hex)
