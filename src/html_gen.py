...
<div class="report-header">
    <div style="text-align: right; font-size: 10px; color: #888; margin-bottom: 5px;">DBBL Scouting Pro</div>
...
def generate_custom_sections_html(offense_df, defense_df, about_df):
    ...
    def make_section(title, df):
        ...
        sh += "<table style='width:100%; border-collapse:collapse; font-size:40px; margin-bottom:20px;'>"
