...
/* Transparenz erzwingen - Wird aktiv, wenn diese Funktion aufgerufen wird */
...
# --- 3. TEAM COMPARISON (HEAD TO HEAD) - UPDATED DESIGN ---
def render_obs_comparison():
    ...
    for label, key in metrics:
        ...
        # Style Definitionen: Weiss Hintergrund, 28px Schrift, Hellgrün für Winner
        base_style = "font-size:28px; padding:10px; background:#ffffff;"
        
        # Hellgrün (#28a745) für bessere Lesbarkeit auf Weiß
