...
def render_live_page():
    ...
    if st.session_state.live_game_id:
        ...
        # FIX: Nicht abbrechen, wenn all_games leer ist, sondern weiterlaufen, 
        # damit die "Keine Spiele für heute"-Logik greift.
...
elif st.session_state.current_page == "team_stats": render_team_stats_page()        [data-testid="stAppViewContainer"] {
            background-image: linear-gradient(rgba(255, 255, 255, 0.8), rgba(255, 255, 255, 0.8)), 
                              url("https://cdn.pixabay.com/photo/2022/11/22/20/25/ball-7610545_1280.jpg");
            background-size: cover; background-position: center; background-repeat: no-repeat;
            background-attachment: fixed;
